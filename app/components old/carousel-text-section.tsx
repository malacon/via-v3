		...
		<div className="flex flex-col justify-center space-y-6">
			...
			>
				{React.Children.toArray(children).map((child, index) => {
					// Check if this is the first paragraph element and clone with className
					...
					if (isFirstParagraph && React.isValidElement(child)) {
						...
						return (
							...
							>
								{React.cloneElement(
									...
									{
										className:
											`${existingClassName} first-paragraph-text`.trim(),
									},
								)}
							</motion.div>
						)
