...
import { CarouselTextSection } from '#app/components copy 3/carousel-text-section.tsx'
import HeroParallax from '#app/components copy 3/HeroParallax.tsx'
...
export default function LifeInVia() {
	...
	return (
		<div className="relative bg-white" style={{ scrollBehavior: 'smooth' }}>
				...
				<div className="relative">
					...
					<div className="absolute inset-0 flex items-center justify-center">
						<div className="mx-auto max-w-7xl px-4 text-center">
							...
							<p className="mx-auto mb-8 max-w-3xl text-lg leading-relaxed text-white drop-shadow-md md:text-xl">
			...
			<nav className="sticky-nav bg-brand-dark-blue border-brand-dark-blue/20 sticky top-[73px] z-30 border-b shadow-lg backdrop-blur-sm md:top-[105px]">
				<div className="mx-auto max-w-7xl px-4">
					<div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 py-4 md:gap-x-6 md:py-5">
						{navSections.map((section) => {
							...
							return (
								<button
									...
									className={`relative cursor-pointer rounded-md px-4 py-2 text-center font-serif text-base font-semibold tracking-wide whitespace-nowrap text-white transition-all duration-200 hover:bg-white/10 hover:text-amber-300 md:px-5 md:py-2.5 md:text-lg ${
										isActive
											? 'bg-white/10 text-amber-300 after:absolute after:right-0 after:bottom-0 after:left-0 after:h-0.5 after:bg-amber-300'
											: ''
									}`}
								>
									{section.label}
			...
			<CarouselTextSection
				...
				className="scroll-mt-24"
			>
				<p className="text-base leading-relaxed text-white md:leading-7">
			...
			{/* Footer - Enhanced */}
			<footer className="relative z-20 border-t-2 border-gray-300 bg-white py-16 md:py-20">
				<div className="mx-auto max-w-7xl px-4">
					<div className="grid gap-10 md:grid-cols-3 md:gap-12">
						...
						<div>
							...
							<nav className="flex flex-col space-y-3">
								<Link
									to="/why-via"
									className="text-base text-neutral-600 transition hover:text-gray-900 hover:underline"
								>
									Why Via?
								</Link>
								<Link
