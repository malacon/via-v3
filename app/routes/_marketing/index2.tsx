...
import { FullWidthBannerLink } from '#app/components copy/full-width-banner-link.tsx'
import { FullWidthSection } from '#app/components copy/full-width-section.tsx'
import HeroCarousel, { type Slide } from '#app/components copy/HeroCarousel.tsx'
import { Button } from '#app/components copy/ui/button.tsx'
import { type Route } from './+types/index2.ts'
...
export default function Index() {
	...
	return (
		<div className="bg-white">
			...
			{/* "Via was born" Section - Clear H2 header with constrained width */}
			<FullWidthSection background="bg-white" padding="py-12 md:py-16 lg:py-20">
				<motion.h2
					className="mx-auto max-w-4xl text-center font-serif text-3xl leading-tight font-normal text-gray-900 md:text-4xl lg:text-5xl"
			...
			{/* Mission/Benefits Section - Redesigned as two-column layout */}
			<FullWidthSection
			...
			>
				<div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-16">
					...
					<div>
						<motion.h3
							className="mb-6 font-serif text-2xl font-normal text-gray-900 md:text-3xl"
							variants={titleVariants}
							initial="hidden"
							whileInView="visible"
							viewport={{ once: true }}
						...
						<motion.ul
							...
							whileInView="visible"
							viewport={{ once: true }}
							className="space-y-3 text-base leading-relaxed text-gray-700 md:text-lg"
						>
			...
			{/* Keep Via Free Section - Redesigned as prominent card-style CTA */}
			<FullWidthSection
				ref={keepViaFreeRef}
				maxWidth="max-w-4xl"
				background="bg-white"
			...
			>
				...
				>
					<div className="text-center">
						...
						<motion.p
							className="mb-8 text-base leading-relaxed text-gray-700 md:mb-10 md:text-lg"
							variants={textVariants}
							initial="hidden"
							animate={keepViaFreeInView ? 'visible' : 'hidden'}
						>
						...
						>
							<Button
								...
								size="lg"
								asChild
								className="bg-brand-dark-blue hover:bg-brand-dark-blue/90 mb-4 w-full max-w-xs px-8 py-6 text-lg font-semibold text-white transition-all hover:shadow-lg md:mb-3 md:w-auto md:px-12 md:py-6"
							>
								<a
